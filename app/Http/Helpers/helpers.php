...
function countProduk($id){
    return Produk::where('toko_id',$id)->count();

}

function countPenjualan($id){
    return Penjualan::where('toko_id',$id)->count();

}
function expiredDate($date){

    $currentDate = Carbon::now();
    $expirationDate = Carbon::parse($date); // Replace with your actual expiration date
