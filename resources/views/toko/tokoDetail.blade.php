...
@section('title')
    Daftar Produk pada  {{$currentToko}}
@endsection

@section('breadcrumb')
    @parent
    <li class="active">Daftar Produk pada  <span class="text-info text-bold"> {{$currentToko}} </span></li>
@endsection
    ...
    function editForm(url) {
        ...
        $.get(url)
            .done((response) => {
                ...
                $('#modal-form [name=toko_id]').val(response.id_kategori);
